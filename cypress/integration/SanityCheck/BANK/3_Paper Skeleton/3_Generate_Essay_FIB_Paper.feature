Feature: PaperSkeleton_03: [EMS-2803][EMS-3515]Generate paper with essay and FIB by skeleton

#     Generate a new paper with a predefined skeleton by matched and not matched essay and FIB questions in paper skeleton page.

    Scenario: Creat essay and FIB question for testing
#         Given Create Essay Question
#         Given Create FIB Question
#     Scenario: Create Skeleton with essay and FIB question
...
#     Scenario: Generate Essay Paper with Skeleton
...
# # Scenario: Delete Delete Skeleton
