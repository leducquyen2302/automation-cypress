Feature: PaperSkeleton_07: [EXAMENA-2279]Create/Edit/View/Delete skeleton with quick mode

#     Create, edit, preview and delete a quick mode skeleton in paper skeleton page.
