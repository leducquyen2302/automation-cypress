Feature: PaperSkeleton_05:[EXAMENA-2650][EXAMENA-2597]Generate paper with Truefalse, Matching and Hotspot questions by skeleton

#     Generate a new paper with a predefined skeleton by matched and not matched truefalse, matching and hot spot questions in paper skeleton page.

    Scenario: Create Skeleton with three types questions
...
#     Scenario: Generate Paper with Skeleton
