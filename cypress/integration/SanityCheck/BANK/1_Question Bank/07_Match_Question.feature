Feature: QuestionBank_07: [EXAMENA-2650] Match Question

    Create True or False question in question bank.

    Scenario: Create Match Question
    ...
    Scenario: Preview Match Question
